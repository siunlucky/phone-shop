...
<div class="flex items-center justify-center p-12">
    <div class="mx-auto w-full max-w-[550px]">
        <form action="/admin/form-product/store" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <textarea rows="4" name="description" id="description" placeholder="Product Description..."
                    class="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
            ...
            <div class="mb-6">
                <label for="image" class="mb-3 block text-base font-medium text-[#07074D]">Upload Product Image</label>
