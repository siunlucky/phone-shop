        ...
        <nav class="flex justify-between w-full bg-zinc-200 text-zinc-700">
            <div class="flex items-center w-full px-5 py-6 xl:px-12">
                ...
                <ul class="hidden px-4 mx-auto space-x-12 font-semibold md:flex font-heading">
                    ...
                    <li><a class="hover:text-black" href="#">Catagory</a></li>
                    <li><a class="hover:text-black" href="#">Collections</a></li>
                    <li><a class="hover:text-black" href="/admin">Manage Product</a></li>
                </ul>
                <!-- Header Icons -->
